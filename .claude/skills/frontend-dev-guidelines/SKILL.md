...
## 🎨 Stitch MCP - UI Prototyping

### Overview

**Stitch MCP** permite generar diseños de pantallas desde descripciones de texto antes de escribir código React. Esto acelera el desarrollo y mejora la comunicación con stakeholders.

### Workflow Recomendado

```
1. Crear Proyecto Stitch
   └─> mcp__stitch__create_project(title: "Mi Feature")

2. Generar Pantallas desde Descripción
   └─> mcp__stitch__generate_screen_from_text(
         project_id: "123",
         prompt: "Dashboard con cards de estadísticas...",
         device_type: "DESKTOP"
       )

3. Revisar Diseño Generado
   └─> mcp__stitch__get_screen(project_id, screen_id)

4. Iterar si es necesario
   └─> Generar variaciones adicionales

5. Implementar en React
   └─> Usar el diseño como referencia para componentes
```
...
|-----------|-------------|
| Dashboard complejo | ✅ Sí |
| Formulario simple | ❌ No |
| Landing page | ✅ Sí |
| Modal básico | ❌ No |
| Sistema de navegación | ✅ Sí |
| Componente reutilizable | ⚠️ Depende de complejidad |

### Prompts Efectivos para Stitch

```
✅ BUENOS prompts:
"Dashboard con 4 cards de KPIs en la parte superior, gráfico de líneas
mostrando tendencias mensuales, tabla de transacciones recientes con
paginación, y sidebar de navegación con iconos"

"Formulario de registro multi-paso con: paso 1 datos personales,
paso 2 información de contacto, paso 3 preferencias, indicador de
...
- `MOBILE` - Diseños mobile-first (320-480px)
- `DESKTOP` - Layouts de escritorio (1024px+)
- `TABLET` - Diseños para tablets (768px)

### Integración con el Workflow de Desarrollo

1. **Antes de codificar**: Genera prototipos en Stitch
2. **Durante la revisión**: Comparte screens con el equipo
3. **Al implementar**: Usa el diseño como guía visual
4. **Para iteraciones**: Genera nuevas versiones rápidamente
